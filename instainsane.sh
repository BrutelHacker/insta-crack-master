#!/bin/bash
# Coded by: Ravi Hacker (Don't change, noob!)
# www.github.com/BrutelHacker
# www.instagram.com/ravi_gmaing_yt24
...
printf "\n"
printf "\e[1;77m\e[41m  Instagram Brute Forcer v1.0, Author: @BrutelHacker (Github)  \e[0m\n" #Don't change, noob
printf "\n"
}
